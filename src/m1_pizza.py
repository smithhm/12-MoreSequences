...
def run_test_generate_points_on_circle():
    ...
    # -------------------------------------------------------------------------
    # Test 2:
    expected = [rg.Point(100.0, 50.0), rg.Point(50.0, 100.0), rg.Point(0.0, 50.0), rg.Point(50.0, 0.00)]
...
def run_test_draw_points_on_circle():
    ...
    # -------------------------------------------------------------------------
    # Test 4
    title = 'Tests 4: 80 purple dots on a black circle'
    window = rg.RoseWindow(400, 400, title)
...
def run_test_pizza():
    ...
    # -------------------------------------------------------------------------
    window = rg.RoseWindow(400, 400, 'Yellow filled Circle with lots of lines')
    circle = rg.Circle(rg.Point(200, 200), 180)
...
def run_test_polygon():
    ...
    # -------------------------------------------------------------------------
    window = rg.RoseWindow(400, 400, 'four segments: black lines on lime green circle')
    circle = rg.Circle(rg.Point(200, 200), 150)
...
def polygon(window, circle, number_of_segments, color, thickness):
    ...
    for k in range(len(segments)):
        line = rg.Line(segments[k-1], segments[k])
        line.thickness = thickness
        line.color = color
        line.attach_to(window)
        line.attach_to(window)
...
def run_test_fancy_polygon():
    ...
    circle = rg.Circle(rg.Point(200, 100), 180)
    circle.fill_color = 'yellow'
    fancy_polygon(window, circle, 300, 25, 'black', 5)
    window.close_on_mouse_click()
